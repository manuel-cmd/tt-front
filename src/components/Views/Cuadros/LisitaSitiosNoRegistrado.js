...
import Sitio from "./SitioNoRegistrado";
...
function ListaSitiosNoRegistrado() {
  ...
  const [preciomenors, setPreciomenor] = useState("");
      ...
      <div class="inicio2">
        <div class="guia2">
          ...
          <div class="datos">
            ...
            {console.log("los sitios son: ", sitios)}
            {sitios.map(
              (sitio) => sitio.habilitado == true && <Sitio items={sitio} />
            )}
            {console.log("los sitios igual son: ", sitios)}
          </div>
        </div>
      </div>
    </div>
...
export default ListaSitiosNoRegistrado;
